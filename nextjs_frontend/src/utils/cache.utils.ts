...
type CACHE_TAG =
  ...
  // customer group
  | "customer-groups"
  | "customer-group-cores"
  | "customers"
  | "customer-cores"

  // bill sales
  | "bill-sales"
  | "bill-sale-core-by-id"
  | "bill-sale-core-by-user"
  | "bill-sale-with-all"

  // bill sales variants
  | "bill-sale-variants"
  | "bill-sale-variant-by-user"

  // product meta
  | "product-types"
  | "product-type-cores"
  | "product-type-with-all"
  | "product-models"
  | "product-model-cores"
  | "product-color-types"
  | "product-color-type-cores"
  | "product-color-type-with-colors"
  | "product-colors"
  | "product-color-cores"
  | "product-names"
  | "product-names-cores"
  ...
  | "product-units-cores"
  | "product-thickness"
  | "product-thickness-cores"
  | "product-brands"
  | "product-brands-cores"
  ...
  // production
  | "production-from-bill-sales"
  | "production-from-bill-sale-core-by-id"

  // delivery
  | "delivery-from-bill-sale-cores";
