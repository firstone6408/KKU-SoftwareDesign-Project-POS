...
public class CustomerController {
    ...
    @GetMapping("/search")
    public ResponseEntity<ApiResponse<List<CustomerResponseDTO>>> getCustomerBySearch(@RequestParam String keyward) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<ApiResponse<Object>> deleteCustomerr(@PathVariable String id) {
